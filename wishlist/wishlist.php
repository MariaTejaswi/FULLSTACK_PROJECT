                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="bg-white border border-[#3B8A9C]/30 rounded-xl shadow hover:shadow-lg transition">
                        ...
                        <div class="p-4 space-y-2">
                            ...
                            <button onclick="addToCart(<?php echo $row['id']; ?>)" class="mt-4 w-full bg-[#3B8A9C] text-white px-4 py-2 rounded transition-transform duration-200 hover:scale-110">Add to Cart</button>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
