...
if (!empty($size)) {
    $sql .= " AND size IN (" . str_repeat('?', substr_count($size, ',') + 1) . ")";
    $sizes = explode(',', $size);
    foreach ($sizes as $s) {
        $params[] = $s;
        $types .= 's';
    ...
    <script>
        ...
        document.getElementById('filter-form').addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                // Restore price inputs (optional, as PHP handles this)
