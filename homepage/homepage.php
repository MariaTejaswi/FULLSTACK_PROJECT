...
<div class="w-full md:w-1/2 relative">
    <img src="\FULLSTACK_PROJECT\images\Hero_img.jpg" alt="Hero Image" class="w-full md:w-[500px] md:h-[700px] object-cover ">
    ...
    <section class="max-w-7xl mx-auto py-16 px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Men's -->
            <div class="relative">
                <img src="\FULLSTACK_PROJECT\images\men's.jpg" alt="Men's" class="w-full h-64 object-cover hover:scale-105">
            ...
            <!-- Women's -->
            <div class="relative">
                <img src="\FULLSTACK_PROJECT\images\women's.avif" alt="Women's" class="w-full h-64 object-cover hover:scale-105">
                <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-gray-300 px-6 py-2">
            ...
            <!-- Kids -->
            <div class="relative">
                <img src="\FULLSTACK_PROJECT\images\kid's.jpg" alt="Kids" class="w-full h-64 object-cover hover:scale-105">
                <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-gray-300 px-6 py-2">
